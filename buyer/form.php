    ...
    default:
        ...
        break;
                ...
                mysqli_query($conn, "INSERT INTO notif (id_notif, id_buyer, id_seller, id_pesan, date, namebuyer, telp, location, locpic, job, status, total) VALUES
                 ('','$idbuyer','$idseller','$idpesan','$tanggal','$nama','$telp','$lokasi','$xx','$pekerjaan','pending','$total')");
...
?>
    ...
    <div class="form-group"> <td>Jumlah Orang</td>
                        ...
                        <tr>
    <div class="form-group"> <td></td><td>: <input type="text" class="form-control-input" name="a2" placeholder=" . . hektar "></td></tr>
