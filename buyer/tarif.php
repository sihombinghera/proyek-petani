...
if(isset($_POST['select1'])){
    ...
    default:
        ...
        break;
                ...
                mysqli_query($conn, "INSERT INTO notif (id_notif, id_buyer, id_seller, id_pesan, date, namebuyer, telp, location, locpic, job, status, total) VALUES
                 ('','$idbuyer','$idseller','$idpesan','$tanggal','$nama','$telp','$lokasi','$buktilokasi','$pekerjaan','pending','$total')");
